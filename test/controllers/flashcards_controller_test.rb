...
class FlashcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flashcard" do
    assert_difference('Flashcard.count') do
      post flashcards_url, params: { flashcard: { a_side: @flashcard.a_side, b_side: @flashcard.b_side, category_id: @flashcard.category_id } }, as: :json
    end
  ...
  test "should update flashcard" do
    patch flashcard_url(@flashcard), params: { flashcard: { a_side: @flashcard.a_side, b_side: @flashcard.b_side, category_id: @flashcard.category_id } }, as: :json
    assert_response 200
  end
